...
import { loginAstrologer } from './useConnetFile';
import { useState } from 'react';
import {Navigate} from 'react-router'
import { useNavigate } from 'react-router';
import { isAstrologerLoggedIn } from '../../auth/AstrologerLoggedIn'; 
import { doAstrologerLogin } from '../../auth/AstrologerLoggedIn';
import { getCurrentAstrologer } from '../../auth/AstrologerLoggedIn'; 
import { useEffect } from 'react';
import { astrologerLogout } from '../../auth/AstrologerLoggedIn';
...
const AstrologerLogin = () => {
  ...
  const handleFormSubmit = (event) => {
    ...
    //login api call
     loginAstrologer(loginDetail)
      .then((response) => {
        console.log("Login successful:",response);
       
        // Save login and navigate to home
        doAstrologerLogin(response, () => {
            navigate("/");
        });
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      <div className="bg-white shadow-xl rounded-lg w-full max-w-md p-8">
        <h2 className="text-2xl font-bold mb-6 text-center text-gray-800">Astrologer Login</h2>
